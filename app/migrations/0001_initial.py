# Generated by Django 5.1.1 on 2025-12-28 04:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AIItineraryDraft',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text_user', models.TextField(db_column='noi_dung_nguoi_dung')),
                ('ai_raw', models.TextField(db_column='noi_dung_ai')),
                ('ai_parsed', models.JSONField(blank=True, db_column='ai_json', null=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('accepted', 'Accepted'), ('rejected', 'Rejected')], db_column='trang_thai', default='pending', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_column='ngay_tao')),
                ('updated_at', models.DateTimeField(auto_now=True, db_column='ngay_cap_nhat')),
                ('user', models.ForeignKey(db_column='nguoidung', on_delete=django.db.models.deletion.CASCADE, related_name='ai_itinerary_drafts', to=settings.AUTH_USER_MODEL)),
                ('accepted_itinerary', models.ForeignKey(blank=True, db_column='lichtrinh_duyet', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_drafts', to='app.itinerary')),
            ],
            options={
                'db_table': 'ai_lichtrinh_nhap',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'status'], name='ai_lichtrin_nguoidu_044156_idx'), models.Index(fields=['created_at'], name='ai_lichtrin_ngay_ta_2bdeb0_idx')],
            },
        ),
        migrations.CreateModel(
