...
urlpatterns = [
    ...
    # Ăn uống
    path('api/food-places/', FoodPlaceListCreateView.as_view(), name='foodplace-list-create'),
    path('api/food-places/<int:pk>/', FoodPlaceDetailView.as_view(), name='foodplace-detail'),
